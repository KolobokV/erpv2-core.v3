...
def generate_tasks_for_client(
    ...
    for ev in events:
        ...
        # E1: bind control event to a process instance
        instance_id: Optional[str] = None
        try:
            instance = find_or_create_process_instance_from_event(ev)
            ...
            # We do not want to break task generation if instance binding fails
            instance_id = None
